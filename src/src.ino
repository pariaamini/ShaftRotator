...
// Arduino pins and button assignments
#define PIN_PLUS_1 2            // Port D2 on Arduino, B3 on PCB
#define PIN_MINUS_1 3           // Port D3 on Arduino, B2 on PCB
#define PIN_JOG 4               // Port D4 on Arduino, B1 on PCB
#define PIN_START_PAUSE_STOP 5  // // Port D5 on Arduino, B4 on PCB
...
int targetRotations = 0;  // # of rotations to be performed by the rotator
...
void startAccelRotChange(void *context) {  // time when long press starts
...
// Central state machine: all button actions update the system here
